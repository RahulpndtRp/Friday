...
class MemoryClient:
    ...
    def add_message(
        self, text: str, *, user_id: str, infer: bool = True
    ) -> Dict[str, Any]:
        """
...
class AsyncMemoryClient:
    ...
    def __init__(
        ...
        self.rag = AsyncRAGPipeline(
            self.memory, top_k=top_k, ltm_threshold=ltm_threshold
        )
    ...
    async def add_message(
        ...
        if self._enabled:
            ...
            self._chat_logs.setdefault(user_id, []).append(
            ...
            if self._msg_counter[user_id] >= self._n:
                ...
                try:
                    await self.add_procedural_memory(
                        self._chat_logs[user_id], user_id=user_id
                    )
    ...
    async def summarize_procedural(
        self,
        ...
        *,
        ...
        return await self.memory.add_procedural_memory(
            messages, user_id=user_id, prompt=prompt
        )
