# Fix for my_mem/llms/openai.py - Replace the existing file with this
...
class OpenAILLM:
    ...
    def generate_response(self, messages, response_format=None, tools=None):
        ...
        return (
            ...
            or chat.choices[0].message.tool_calls[0].to_dict()
        )
...
class AsyncOpenAILLM:
    ...
    async def generate_response_async(self, messages, response_format=None, tools=None):
        ...
        return chat.choices[0].message.content or (
            chat.choices[0].message.tool_calls[0].to_dict()
